  ...
  return (
    <div className="cf-overlay">
      ...
      <div className="cf-header">
        ...
        <div className="cf-title-wrap">
          ...
          <div className="cf-country-meta">
            {dossier.officialName} · {dossier.region} · Pop.&nbsp;{dossier.population}
          </div>
        </div>
        ...
        >
          <div>
            <div className="cf-risk-num" style={{ color: rc.text }}>{dossier.riskScore}</div>
            <div className="cf-risk-lbl" style={{ color: rc.text }}>Instability</div>
          </div>
          <div className="cf-risk-delta" style={{ color: rc.text }}>
            ↑&nbsp;+{dossier.riskChange}
          </div>
        </div>
      </div>
      ...
      <div className="cf-body">
        ...
        {/* Row 1 — 3-col: Situation Brief | Current Stats | Key Entities */}
        <div className="cf-grid">
          ...
          <div className="cf-card" style={accent('#FF2040')}>
            ...
            <div className="cf-card-body">
              <p className="cf-situation">{dossier.situation}</p>
            </div>
          </div>
        ...
        {/* Row 2 — 2-col: Event Timeline | Financial Impact */}
        ...
        {/* Row 3 — 2-col: AI Predictions | Military Posture */}
        <div className="cf-grid-2">
